...
<title>尾山台のカウンターフレンチ ～a Bee～アベー～</title>
<meta name="keywords" content="尾山台,フレンチ,ワイン,ランチ" />
<meta name="description" content="東急大井町線尾山台駅で美味しいフレンチを愉しむなら「 à Bêe (アベー)」へどうぞ。旬の食材をふんだんに使用した料理をランチ、もしくはディナーでお召し上がりください。ワインも多数ご用意しております。
...
<div id="wrapper">
  <div id="header">
    ...
    <div id="belt">
      <h1>素材に真っ直ぐと向き合う、正統派フレンチ「アベー」</h1>
      <p id="logo"><img src="shared/img/logo.png" width="166" height="134" alt=" aBee（アベー）" /></p>
      <p id="h_reserve"><a href="https://yoyaku.toreta.in/abee2013/#/" target="_blank" rel="nofollow">WEB予約</a></p>
  ...
  <div id="container">
    <div id="lead" class="content clearfix sec_box">
      <p>当店では、ランチ・ディナーともにコースにてご提供し、<br />
...
フォアグラ農家でも経験を積んだ。</p>
    ...
    <div id="lunch" class="content sec_box">
      ...
      <div class="info">
        <h3>ランチ　<span class="f_eng">2,500</span>円(税込)</h3>
        <h4>～ある日の一例～</h4>
        <div class="menu_list">
          <dl>
            <dt>前菜</dt>
          ...
          <dl>
            <dt>食後</dt>
            <dd>コーヒーor 紅茶or エスプレッソ</dd>
          </dl>
        </div>
        <p class="attention mb10">※前菜・メインは肉<span class="f_eng">or</span>魚をお選びいただけます<br />
          ※席数が限られておりますので、事前予約をお願い致します。</p>
      </div>
	  <div class="txt_note">
    ...
    <div id="dinner" class="sec_bg sec_box">
      <div class="content clearfix">
        ...
        <div class="info">
          <h3>ディナー おすすめコース　<span class="f_eng">4,900</span>円(税込)</h3>
          <h4>～ある日の一例～</h4>
          <div class="menu_list">
		  	<dl class="padd">
              <dt>アミューズ</dt>
...
※食後のお飲み物とデザートは<br />
＋<span class="f_eng">600</span>円(コーヒー、紅茶、エスプレッソ)です。</p>
        ...
        <p><span class="f_eng">6,800</span>円(税込)<br />
        <span class="f_eng">8,000</span>円(税込)</p>
		<p>※詳細はお問い合わせください。</p>
		</div>
    ...
    <div id="access" class="sec_bg sec_box">
      <div class="content">
        ...
        <div class="info">
          <p><strong>フランス料理レストラン　à Bêe (アベー)</strong></p>
...
皆様のご来店を心よりお待ちしております。</p>
        ...
        <div class="contact">
		  ...
		  <p class="tel_txt">※当日のキャンセルはコースの金額を100％頂戴させて頂きます。</p>
        </div>
      </div>
    </div>
    ...
    <div id="group" class="content clearfix">
      <div id="news">
		...
		$rss = get_ameba_rss("http://feedblog.ameba.jp/rss/ameblo/abee2013/rss20.xml",3,56);
		foreach( $rss as $item ) : ?>
