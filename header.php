...
<head>
	...
	<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/shared/css/shared.css" type="text/css" />
	<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/shared/css/style.css" type="text/css" />
	<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/shared/css/news.css" type="text/css" />
	<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/shared/css/blog.css" type="text/css" />
...
<![endif]-->
	<script src="<?php echo get_template_directory_uri(); ?>/shared/js/respond.src.js" type="text/javascript"></script>

	<!--<script type="text/javascript" src="shared/js/scrolltopcontrol.js"></script>-->
	<script src="https://www.google.com/jsapi" type="text/javascript"></script>
	<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/shared/js/jquery.bxslider.js"></script>
	<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDtdx9nSDstjJOTDGsGnHC5nqmFmJXi4G8"></script>
	<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/shared/js/googlemap.js"></script>
