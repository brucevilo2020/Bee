...
<section class="news_section">
    <img class="img_title" src="<?php echo get_template_directory_uri(); ?>/shared/img/news_header.png" alt="">
    <?php
 ...
 －</span><br />
    ...
    <div id="group" class=" clearfix">
        ...
        <div id="instagram">
            ...
            <div class="box">
                <blockquote class="instagram-media" data-instgrm-permalink="https://www.instagram.com/p/CNZF0-Cgi54/?utm_source=ig_embed&amp;utm_campaign=loading" data-instgrm-version="13" style="height: 485px; background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 0 !important; max-width:300px; padding:0; width:99.375%; width:-webkit-calc(100% - 2px); width:calc(100% - 2px);">
                    <div style="padding:16px;"> <a href="https://www.instagram.com/p/CNZF0-Cgi54/?utm_source=ig_embed&amp;utm_campaign=loading" style=" background:#FFFFFF; line-height:0; padding:0 0; text-align:center; text-decoration:none; width:100%;" target="_blank">
