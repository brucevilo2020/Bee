...
<div id="wrapper">
  <div id="header">
    ...
    <li class="current"><a href="#top"><img src="shared/img/nav1.png" width="120" height="40" alt="TOP"  class="over" /></a></li>
        ...
        <li ><a href="#lunch"><img src="shared/img/nav3.png" width="120" height="40" alt="LUNCH " class="over" /></a></li>
        <li class="padd"><a href="#dinner"><img src="shared/img/nav4.png" width="125" height="40" alt="DINNER" class="over" /></a></li>
...
＋<span class="f_eng">800</span>円(税込) です。</p>
        ...
        <span class="f_eng">8,800</span>円(税込)</p>
		<p>※詳細はお問い合わせください。</p>
		</div>
